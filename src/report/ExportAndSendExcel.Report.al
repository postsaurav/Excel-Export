report 90002 "SDH Export And Send Excel"
{
    ...
    var
        ...
        EmailHelper: Codeunit "SDH Email Helper";
    ...
    begin
        ...
        EmailHelper.SendEmail('postsaurav@gmail.com', '', '', 'Sample Email', EmailScenario::Default, TempBlob, 'Email From BC.xlsx');
